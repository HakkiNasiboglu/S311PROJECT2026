...
abstract class CompositeElement implements WorkElement {
    ...
    public void accept(OrgVisitor visitor) {
        ...
        for (WorkElement element : getList()) element.accept(visitor);
    }
...
class Department extends CompositeElement {
    ...
    public void display(int indent) {
        ...
        for (WorkElement element : list) element.display(indent + 1);
    }
...
class Team extends CompositeElement {
    ...
    public void display(int indent) {
        ...
        for (WorkElement member : list) member.display(indent + 1);
    }
...
class Employee implements WorkElement {
    ...
    @Override
    public void addElement(WorkElement element) {System.out.println("Wrong command: Employee cannot have children.");}

    @Override
    public void removeElement(WorkElement element) {System.out.println("Wrong command: Employee has no children to remove.");}
